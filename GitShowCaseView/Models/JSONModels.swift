...
struct UserDecoder: Decodable {
    ...
    static let shared = UserDecoder(login: "Hiroio", avatar_url: "https://avatars.githubusercontent.com/u/76852167?v=4", html_url: "https://github.com/users/Hiroio", repos_url: "https://api.github.com/users/Hiroio/repos", type: "User", name: "Vlad", location: "Ukraine", bio: "Hi! I`m Vlad, I'm from Ukraine", public_repos: 9, created_at: "2021-01-01T21:15:55Z")
    
    
    init(login: String, avatar_url: String, html_url: String, repos_url: String, type: String, name: String, location: String, bio: String, public_repos: Int, created_at: String) {
        self.login = login
